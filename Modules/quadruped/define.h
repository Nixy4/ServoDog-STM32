...
bool legs_acb_update(void);
void legs_acb_update_block(void);
...
bool legs_ccb_update(void);
void legs_ccb_update_block(void);

void fixed_set_angle_zero(void);
void fixed_set_angle_mid(void);
void fixed_set_stand0(void);
void fixed_set_stand1(void);
void fixed_set_stand2(uint32_t frame_count);
void fixed_set_stand3(uint32_t frame_count);
